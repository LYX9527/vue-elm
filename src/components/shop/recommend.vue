<template>
  <div class="recommend">
    <div class="nav">
      ...
      <span class="nav_title">推荐有奖</span>
      <div class="ic"></div>
    </div>
    ...
    <div class="footer">
      <div>
        <p>累计收益</p>
        <p>
          <span style="font-size: 18px; color: #ff5633; font-weight: bold"
            >0</span
          >元
        </p>
      </div>
      <div>
        <p>成功邀请</p>
        <p><span style="font-size: 18px; font-weight: bold">0</span>元</p>
      </div>
    </div>
    ...
    <div class="tips">
      ...
      />
      <p style="font-size:.8rem;">还不赶紧去邀请好友</p>
    </div>
  </div>
</template>
